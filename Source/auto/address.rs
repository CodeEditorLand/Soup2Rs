...
impl Address {
	...
	// pub fn from_sockaddr(sa: /*Unimplemented*/Option<Fundamental: Pointer>, len:
	// i32) -> Option<Address> {    unsafe { TODO: call
	// ffi:soup_address_new_from_sockaddr() }
	//}
}
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_physical_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
