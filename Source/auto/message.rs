...
pub trait MessageExt: 'static {
	...
	// fn add_header_handler<P: Fn() + 'static>(&self, signal: &str, header: &str,
	// callback: P, user_data: /*Unimplemented*/Option<Fundamental: Pointer>) ->
	// u32;
	...
	fn connect_is_top_level_navigation_notify<F:Fn(&Self) + 'static>(&self, f:F)
	-> SignalHandlerId;
...
impl<O:IsA<Message>> MessageExt for O {
	// fn add_header_handler<P: Fn() + 'static>(&self, signal: &str, header: &str,
	// callback: P, user_data: /*Unimplemented*/Option<Fundamental: Pointer>) -> u32
	// {    unsafe { TODO: call ffi:soup_message_add_header_handler() }
	//}

	// fn add_status_code_handler<P: Fn() + 'static>(&self, signal: &str,
	// status_code: u32, callback: P, user_data:
	// /*Unimplemented*/Option<Fundamental: Pointer>) -> u32 {    unsafe { TODO:
	// call ffi:soup_message_add_status_code_handler() }
	//}
	...
	fn set_reason_phrase(&self, reason_phrase:Option<&str>) {
		unsafe {
			glib::gobject_ffi::g_object_set_property(
				self.to_glib_none().0 as *mut glib::gobject_ffi::GObject,
				b"reason-phrase\0".as_ptr() as *const _,
				reason_phrase.to_value().to_glib_none().0,
			);
		}
	}
	...
	fn set_site_for_cookies(&self, site_for_cookies:Option<&URI>) {
		unsafe {
			glib::gobject_ffi::g_object_set_property(
				self.to_glib_none().0 as *mut glib::gobject_ffi::GObject,
				b"site-for-cookies\0".as_ptr() as *const _,
				site_for_cookies.to_value().to_glib_none().0,
			);
		}
	}
	...
	fn set_status_code(&self, status_code:u32) {
		unsafe {
			glib::gobject_ffi::g_object_set_property(
				self.to_glib_none().0 as *mut glib::gobject_ffi::GObject,
				b"status-code\0".as_ptr() as *const _,
				status_code.to_value().to_glib_none().0,
			);
		}
	}
	...
	fn set_tls_certificate<P:IsA<gio::TlsCertificate>>(&self, tls_certificate:Option<&P>) {
		unsafe {
			glib::gobject_ffi::g_object_set_property(
				self.to_glib_none().0 as *mut glib::gobject_ffi::GObject,
				b"tls-certificate\0".as_ptr() as *const _,
				tls_certificate.to_value().to_glib_none().0,
			);
		}
	}
	...
	fn set_tls_errors(&self, tls_errors:gio::TlsCertificateFlags) {
		unsafe {
			glib::gobject_ffi::g_object_set_property(
				self.to_glib_none().0 as *mut glib::gobject_ffi::GObject,
				b"tls-errors\0".as_ptr() as *const _,
				tls_errors.to_value().to_glib_none().0,
			);
		}
	}
	...
	//#[cfg_attr(feature = "dox", doc(cfg(feature = "v2_28")))]
	// fn connect_content_sniffed<Unsupported or ignored types>(&self, f: F) ->
	// SignalHandlerId {    Empty ctype params: *.HashTable TypeId { ns_id: 0, id:
	// 28 }/TypeId { ns_id: 0, id: 28 }
	//}
	...
	fn connect_got_body<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					got_body_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_got_chunk<F:Fn(&Self, &Buffer) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					got_chunk_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_got_headers<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					got_headers_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_got_informational<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					got_informational_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_network_event<F:Fn(&Self, gio::SocketClientEvent, &gio::IOStream) + 'static>(
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					network_event_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_restarted<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					restarted_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_starting<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					starting_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_wrote_body<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					wrote_body_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	#[cfg_attr(feature = "dox", doc(cfg(feature = "v2_24")))]
	fn connect_wrote_body_data<F:Fn(&Self, &Buffer) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn wrote_body_data_trampoline<P:IsA<Message>, F:Fn(&P, &Buffer) + 'static>(
			this:*mut ffi::SoupMessage,
			chunk:*mut ffi::SoupBuffer,
			f:glib::ffi::gpointer,
		) {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					wrote_body_data_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_wrote_chunk<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					wrote_chunk_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_wrote_headers<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					wrote_headers_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_wrote_informational<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					wrote_informational_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_first_party_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_first_party_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_http_version_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_http_version_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_reason_phrase_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_reason_phrase_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_request_body_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_request_body_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	#[cfg_attr(feature = "dox", doc(cfg(feature = "v2_46")))]
	fn connect_request_body_data_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_request_body_data_trampoline<P:IsA<Message>, F:Fn(&P) + 'static>(
			this:*mut ffi::SoupMessage,
			_param_spec:glib::ffi::gpointer,
			f:glib::ffi::gpointer,
		) {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_request_body_data_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_request_headers_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_request_headers_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_response_body_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_response_body_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_response_headers_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_response_headers_trampoline<P:IsA<Message>, F:Fn(&P) + 'static>(
			this:*mut ffi::SoupMessage,
			_param_spec:glib::ffi::gpointer,
			f:glib::ffi::gpointer,
		) {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_response_headers_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
	...
	fn connect_site_for_cookies_notify<F:Fn(&Self) + 'static>(&self, f:F) -> SignalHandlerId {
		unsafe extern fn notify_site_for_cookies_trampoline<P:IsA<Message>, F:Fn(&P) + 'static>(
			this:*mut ffi::SoupMessage,
			_param_spec:glib::ffi::gpointer,
			f:glib::ffi::gpointer,
		) {
		...
		unsafe {
			...
			connect_raw(
				...
				Some(transmute::<_, unsafe extern fn()>(
					notify_site_for_cookies_trampoline::<Self, F> as *const (),
				)),
				Box_::into_raw(f),
			)
		}
...
impl fmt::Display for Message {
	fn fmt(&self, f:&mut fmt::Formatter) -> fmt::Result { f.write_str("Message") }
}
