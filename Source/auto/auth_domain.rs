...
impl<O:IsA<AuthDomain>> AuthDomainExt for O {
	...
	// *mut glib::gobject_ffi::GObject, b"filter-data\0".as_ptr() as *const _,
	...
	// StaticType>::static_type());
	//        glib::gobject_ffi::g_object_get_property(self.to_glib_none().0 as
	// *mut glib::gobject_ffi::GObject, b"generic-auth-data\0".as_ptr() as
	// *const _, value.to_glib_none_mut().0);        value.get().expect("Return
	// Value for property `generic-auth-data` getter")    }
	//}
	...
	//        glib::gobject_ffi::g_object_set_property(self.to_glib_none().0 as
	// *mut glib::gobject_ffi::GObject, b"generic-auth-data\0".as_ptr() as
	// *const _, generic_auth_data.to_value().to_glib_none().0);    }
	//}
