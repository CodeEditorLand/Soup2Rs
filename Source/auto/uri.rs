...
impl URI {
	...
	pub fn copy_host(&mut self) -> Option<URI> {
		unsafe { from_glib_full(ffi::soup_uri_copy_host(self.to_glib_none_mut().0)) }
	}
	...
	pub fn fragment(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_uri_get_fragment(self.to_glib_none_mut().0)) }
	}
	...
	pub fn host(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_uri_get_host(self.to_glib_none_mut().0)) }
	}
	...
	pub fn password(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_uri_get_password(self.to_glib_none_mut().0)) }
	}
	...
	pub fn path(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_uri_get_path(self.to_glib_none_mut().0)) }
	}
	...
	#[doc(alias = "get_port")]
	pub fn port(&mut self) -> u32 { unsafe { ffi::soup_uri_get_port(self.to_glib_none_mut().0) } }
	...
	pub fn query(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_uri_get_query(self.to_glib_none_mut().0)) }
	}
	...
	pub fn scheme(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_uri_get_scheme(self.to_glib_none_mut().0)) }
	}
	...
	pub fn user(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_uri_get_user(self.to_glib_none_mut().0)) }
	}
	...
	// pub fn set_query_from_fields(&mut self, first_field: &str, : /*Unknown
	// conversion*//*Unimplemented*/Fundamental: VarArgs) {    unsafe { TODO:
	// call ffi:soup_uri_set_query_from_fields() }
	//}
	...
	pub fn to_string(&mut self, just_path_and_query:bool) -> Option<glib::GString> {
		unsafe {
			from_glib_full(ffi::soup_uri_to_string(
				self.to_glib_none_mut().0,
				just_path_and_query.into_glib(),
			))
		}
	}
	...
	pub fn uses_default_port(&mut self) -> bool {
		unsafe { from_glib(ffi::soup_uri_uses_default_port(self.to_glib_none_mut().0)) }
	}
