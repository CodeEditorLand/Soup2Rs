...
impl ClientContext {
	...
	pub fn address(&mut self) -> Option<Address> {
		unsafe { from_glib_none(ffi::soup_client_context_get_address(self.to_glib_none_mut().0)) }
	}
	...
	pub fn auth_user(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_client_context_get_auth_user(self.to_glib_none_mut().0)) }
	}
	...
	pub fn gsocket(&mut self) -> Option<gio::Socket> {
		unsafe { from_glib_none(ffi::soup_client_context_get_gsocket(self.to_glib_none_mut().0)) }
	}

	#[doc(alias = "soup_client_context_get_host")]
	#[doc(alias = "get_host")]
	pub fn host(&mut self) -> Option<glib::GString> {
		unsafe { from_glib_none(ffi::soup_client_context_get_host(self.to_glib_none_mut().0)) }
	}
	...
	pub fn socket(&mut self) -> Option<Socket> {
		unsafe { from_glib_none(ffi::soup_client_context_get_socket(self.to_glib_none_mut().0)) }
	}
