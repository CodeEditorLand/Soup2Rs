...
impl Date {
	...
	pub fn minute(&mut self) -> i32 {
		unsafe { ffi::soup_date_get_minute(self.to_glib_none_mut().0) }
	}
	...
	pub fn month(&mut self) -> i32 {
		unsafe { ffi::soup_date_get_month(self.to_glib_none_mut().0) }
	}
	...
	pub fn offset(&mut self) -> i32 {
		unsafe { ffi::soup_date_get_offset(self.to_glib_none_mut().0) }
	}
	...
	pub fn second(&mut self) -> i32 {
		unsafe { ffi::soup_date_get_second(self.to_glib_none_mut().0) }
	}
	...
	pub fn is_past(&mut self) -> bool {
		unsafe { from_glib(ffi::soup_date_is_past(self.to_glib_none_mut().0)) }
	}
	...
	pub fn to_time_t(&mut self) -> libc::c_long {
		unsafe { ffi::soup_date_to_time_t(self.to_glib_none_mut().0) }
	}
